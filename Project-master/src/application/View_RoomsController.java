...
/**
 * 
 * <p> This is View_RoomsController  associated with the ViewRoomForm.fxml </p>
 *  <p> It as the name suggest openes a theatre like room viewing system</p>
...
public class View_RoomsController {
	...
	private void viewroom123Click(ActionEvent event) throws IOException{
		...
		controller.mem=mem;
		controller.start.setText(start.getValue().toString());controller.roomCap.setText(Integer.toString(mem.thisCollege.getRoom(btn123.getText()).Capacity));controller.roomCap.setText(Integer.toString(mem.thisCollege.getRoom(btn123.getText()).Capacity));
